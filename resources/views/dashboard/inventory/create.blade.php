                    ...
                    <div class="card-body">
                        <form action="{{ route('inventories.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                is-invalid
                            @enderror"
                                    id="quantity" placeholder="Masukkan Quantity" name="quantity" />
                                @error('quantity')
                            ...
                            <div class="mb-3">
                                ...
                                is-invalid
                            @enderror"
                                    id="unit" placeholder="Masukkan Unit" name="unit" />
                                @error('unit')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                is-invalid
                            @enderror"
                                    id="price" placeholder="Masukkan Harga" name="price" />
                                @error('price')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                is-invalid
                            @enderror"
                                    id="size" placeholder="Masukkan Size" name="size" />
                                @error('size')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
