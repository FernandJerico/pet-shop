                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        @elseif ($transaction->paid == 1)
                            <h5>Payment Status: <span class="badge bg-label-success me-1">Paid</span></h5>
                        @endif
                    </div>
                    <div class="col-md-6">
                        <form action="{{ route('admin.order-list.update', $transaction->id) }}" method="POST">
                            ...
                            @method('PUT')
                            @if ($transaction->status == 'pending')
                                <button type="submit" class="btn btn-primary text-white btn-sm" name="status"
                                    value="success">
                                    Success
                                </button>
                                <button type="submit" class="btn btn-danger text-white btn-sm" name="status"
                                    value="cancel">
                                    Cancel
                                </button>
                            @elseif ($transaction->status == 'success')
                                <button type="submit" class="btn btn-dark text-white btn-sm" name="status"
                                    value="pending">
                                    Pending
                                </button>
                                <button type="submit" class="btn btn-danger text-white btn-sm" name="status"
