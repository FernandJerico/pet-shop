                            ...
                            <div class="d-flex align-items-center col-8">
                                ...
                                <div>
                                    ...
                                    <p class="mb-1 mb-sm-1"><small><b>Price:</b> <span
                                                class="price">{{ number_format($item->price) }}</span></small></p>
                                    <div>
                                        <div class="input-group">
                                            ...
                                            <input type="number"
                                                ...
                                                aria-label="Example text with button addon" value="{{ $item->quantity }}"
                                                aria-describedby="button-addon1" data-id="{{ $item->id }}" readonly>
